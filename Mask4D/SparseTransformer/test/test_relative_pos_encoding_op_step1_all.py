...
attn_flat = pointops.attention_step1(query.float(), key.float(), index_q.int(), index_k.int())
...
table_q.requires_grad = True
table_k.requires_grad = True
output_v2 = sptr.dot_prod_with_idx_all(query, index_q.int(), index_q_offsets.int(), n_max, key, ctg_index_1_offsets.int(), index_k.int(), table_q, table_k, rel_index.int())
loss = output_v2.mean()
loss.backward()
